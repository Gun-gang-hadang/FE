...
import MealScreen from './components/mealPage/MealScreen';
import bloodrecordScreen from './components/bloodPage/BloodrecordScreen';
  ...
  return (
    <NavigationContainer>
      <Tab.Navigator
        ...
        <Tab.Screen name="내 혈당" component={bloodrecordScreen} />
        <Tab.Screen name="식단분석" component={MealScreen} />
